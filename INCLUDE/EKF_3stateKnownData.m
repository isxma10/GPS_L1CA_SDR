function [EKF_track]=EKF_3stateKnownData(EKF_track,I_P,Q_P)
% Performs carrier tracking via an EKF when data wipeoff is employed
%
%[EKF_track] = EKF_3stateKnownData(EKF_track,I_P,Q_P)
%
%   Inputs:
